...
return [
  ...
  */
  ...
  | convención "nombre-atributo.regla" para nombrar las líneas. Esto nos ayuda a
  | especificar rápidamente una línea de lenguaje personalizada específica para una regla de atributo dada.
  |
  */
